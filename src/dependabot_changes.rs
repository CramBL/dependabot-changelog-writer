...
mod tests {
    ...
    fn test_parse_body() {
        ...
        assert_eq!(changes[0], DependabotChange::new("`crate-ci/typos`", "1.27.0", "1.28.4"));
        assert_eq!(changes[1], DependabotChange::new("`docker/login-action`", "3d58c274f17dffee475a5520cbe67f0a882c4dbb", "7ca345011ac4304463197fac0e56eab1bc7e6af0"));
    ...
    fn test_parse_example_to_changes_7_crates_semver() {
        ...
        assert_eq!(changes[0], DependabotChange::new("`serde`", "1.0.215", "1.0.216"));
        assert_eq!(changes[1], DependabotChange::new("`chrono`", "0.4.38", "0.4.39"));
        assert_eq!(changes[2], DependabotChange::new("`semver`", "1.0.23", "1.0.24"));
        assert_eq!(changes[3], DependabotChange::new("`env_logger`", "0.11.5", "0.11.6"));
        assert_eq!(changes[4], DependabotChange::new("`zip`", "2.2.1", "2.2.2"));
        assert_eq!(changes[5], DependabotChange::new("`wasm-bindgen-futures`", "0.4.47", "0.4.49"));
        assert_eq!(changes[6], DependabotChange::new("`web-sys`", "0.3.74", "0.3.76"));
        assert_eq!(changes[7], DependabotChange::new("`thiserror`", "2.0.4", "2.0.9"));
