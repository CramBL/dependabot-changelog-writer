...
- `log`: 0.4.27 → 0.4.28 ([#102](https://github.com/CramBL/dependabot-changelog-writer/pull/102))
- `serde_json`: 1.0.140 → 1.0.145 ([#102](https://github.com/CramBL/dependabot-changelog-writer/pull/102))
- `tempfile`: 3.20.0 → 3.22.0 ([#102](https://github.com/CramBL/dependabot-changelog-writer/pull/102))
