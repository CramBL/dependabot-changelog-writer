...
- `env_logger`: 0.11.8 → 0.11.9 ([#113](https://github.com/CramBL/dependabot-changelog-writer/pull/113))
...
- `assert_cmd`: 2.0.17 → 2.2.0 ([#118](https://github.com/CramBL/dependabot-changelog-writer/pull/118))
